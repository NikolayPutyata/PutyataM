...
const FormForFeedback = () => {
  return (
    <div className="flex flex-col md:flex-row max-w-full md:max-w-5xl mx-auto bg-white rounded-xl overflow-hidden
                sm:h-auto sm:max-h-[90vh] sm:overflow-y-auto">
  {/* LEFT IMAGE */}
  ...
  {/* RIGHT FORM */}
  <div className="flex w-full flex-col justify-center p-4 sm:p-6 md:w-7/12">
